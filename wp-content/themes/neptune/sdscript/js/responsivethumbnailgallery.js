...
(function($) {
    ...
    $.ThumbnailGallery = function(el, options) {
        ...
        var defaults = {
            thumbImages: 'wp-content/themes/neptune/sdscript/img/thumbs/thumb',
            smallImages: '/gunter2/wp-content/themes/neptune/sdscript/img/small/image',
            largeImages: '/gunter2/wp-content/themes/neptune/sdscript/img/large/image',
            count: 10,
            thumbImageType: 'jpg',
            breakpoint: 600,
            imageType: 'png',
